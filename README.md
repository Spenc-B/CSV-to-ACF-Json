...
- **Repeater detection**: Numbered column patterns like `prefix_1_suffix`, `prefix_2_suffix` are auto-grouped into ACF Repeater fields. Break apart any mis-detected groups with one click
